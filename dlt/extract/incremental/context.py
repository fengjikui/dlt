...
class _IntervalAccessor:
    ...
    def apply_lag(self, trigger: str, count: int = 1, lag_end: bool = False) -> "_IntervalAccessor":
        ...
        """
        # inline import: requires hub extras (croniter)
        from dlt._workspace.deployment.interval import lag_interval
    ...
    def apply_full_days(self) -> "_IntervalAccessor":
        ...
        """
        # inline import: requires hub extras (croniter)
        from dlt._workspace.deployment.interval import full_days_interval
